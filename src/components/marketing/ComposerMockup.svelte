<script lang="ts">
  ...
  let draft = $state({
    baseText:
      'Shipped Shoutrrr 1.0 today 🚀 The open-source social scheduler: draft once, then fan it out to X, LinkedIn, Bluesky, and more at the same time — with a live per-network character count and auto-threading. Self-host it free, or start on our managed Cloud. No per-seat pricing. Grab it on GitHub and deploy in a minute.',
  ...
  const xPost = {
    text: 'Shipped Shoutrrr 1.0 today 🚀 The open-source social scheduler: draft once, then fan it out to X, LinkedIn, Bluesky, and more at the same time — with a live per-network character count and auto-threading.',
    time: 'now',
    replies: '18',
    reposts: '64',
    likes: '291',
